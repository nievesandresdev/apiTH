        ...
        <tr>
            <td style="vertical-align: top;">
                ...
                <div class="container-text">
                    <h1 class="title" style="margin:0;font-weight: 600;line-height: 110%;font-family:Arial;">{{ __('mail.inviteGuestFromSaas.headerTitle', ['hotel' => $hotel->name]) }}</h1>
                    <p class="description" style="margin:0;color: #333;font-weight: 400;line-height: 28px;margin-top:24px;font-family:Arial;">
                        {{ __('mail.inviteGuestFromSaas.headerBody', ['hotel' => $hotel->name]) }}
                    </p>
                </div>
                <a
                    href="{{$urlWebapp}}"
                ...
                >
                    {{ __('mail.inviteGuestFromSaas.button') }}
                </a>
            </td>
