<section style="background: #FFFFFF; border-radius: 3px; margin-left: 16px; margin-right: 16px; margin-top: 24px;">
    ...
    <!-- Tabla de íconos -->
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 16px; text-align: center; padding-left: 10px; padding-right: 40px">
        <tr>
            <!-- Muy Mala -->
