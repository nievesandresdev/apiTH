...
<body style="margin: 0; padding: 0; background-color: #ffffff;font-family: Arial, Helvetica, sans-serif;">
    ...
    <div style="background-color: #fff;">
        <p style="margin:0;padding:24px 0; color: #000;text-align: center;font-size: 28px;font-weight: 600;line-height: 110%;">{{$hotel['name']}}</p>
    ...
    <div class="responsive-table" style="width: 100%; max-width: 568px; margin: 0 auto;border-radius: 3px 3px 50px 3px;background: #F3F3F3;padding: 44px 40px;">
        <table>
            <tr>
                <td>
                    <div>
                        <h1 style="margin:0;font-size: 26px;font-weight: 600;line-height: 110%;">Tienes un chat pendiente.</h1>
                        <p style="margin:0;font-size: 16px;font-weight: 400;line-height: 150%;margin-top:16px">Tienes un chat pendiente en la WebApp que requiere tu atención. Te recomendamos revisarlo lo antes posible.</p>
                        <div class="align-boton" style="margin-top:32px;"> 
                            <a href="{{$webappLink}}" style="height: 44px;padding: 12px 0;border-radius: 6px;background-color: #333;color: #FFF;text-align: center;font-size: 18px;font-weight: 600;line-height: 110%;box-sizing: border-box;display: block;text-decoration:none;">
                                Ir a la WebApp
                            </a>
                        </div>
                    </div>
    ...
    <div class="responsive-table-2" style="margin:auto;padding: 40px 24px 48px 24px;border-radius: 3px 3px 50px 3px;background: #F3F3F3;max-width:450px">
        ...
        <div style="margin-top: 24px">
            <h1 style="margin:0;font-size: 24px;font-weight: 600;line-height: 110%;">Tienes un chat pendiente.</h1>
            <p style="margin:0;font-size: 16px;font-weight: 400;line-height: 150%;margin-top:16px">Tienes un chat pendiente en la WebApp que requiere tu atención. Te recomendamos revisarlo lo antes posible.</p>
            <div class="align-boton" style="margin-top:32px;"> 
                <a href="{{$webappLink}}" style="padding: 12px 0;border-radius: 6px;background-color: #333;color: #FFF;text-align: center;font-size: 18px;font-weight: 600;line-height: 110%;box-sizing: border-box;display: block;text-decoration:none;">
                    Ir a la WebApp
                </a>
            </div>
        </div>
    ...
    <div style="padding: 48px 24px; max-width:479px; margin:auto">
        <h1 style="margin: 0;font-size: 22px;font-weight: 600;line-height: 150%;">Mensajes pendientes</h1>
        @foreach($unansweredMessagesData as $chat)
        <div style="padding-top:24px;">
            @if($chat['guest_name']) 
            <p style="margin: 0;font-size: 16px;font-style: normal;font-weight: 400;line-height: 150%;">{{ $chat['guest_name'] }}</p>
            @endif
            <div style="padding: 12px;border-radius: 6px 6px 0px 6px;border: 1px solid #BFBFBF;margin-top:4px">
                <p style="margin: 0;font-size: 16px;font-weight: 400;line-height: 150%;">{{ $chat['message_text'] }}</p>
            </div>
            <p style="margin: 0;font-size: 14px;font-weight: 400;line-height: 140%;color:#A0A0A0;margin-top:8px;text-align: right;">{{ $chat['sent_at'] }}</p>
        </div>
        @endforeach
    </div>

    <div style="margin-top: 16px;margin-bottom: 64px; padding:0 24px">
        <h1 style="margin:0;font-size: 22px;font-weight: 600;line-height: 150%;text-align: center;">Responde al mensaje</h1>
    ...
    <div style="padding: 24px 32px;background-color:#333">
        <table  class="responsive-foot" style="width: 100%">
            <tr>
                <td><p class="text-footer" style="font-size: 14px;font-weight: 400;line-height: 150%;color:#fff">Av. de Velázquez, 212, Churriana, 29004 Málaga</p></td>
                <td style="width: 107px">
                    <div>
                        <h3 class="footer-w-text" style="margin: 0;font-size: 16px;font-weight: 600;line-height: 150%;color:#fff">Redes sociales</h3>
        ...
        <div style="margin:24px auto;width:312px">
            <table style="width: 100%">
                <tr>
                    <td style="padding-right: 8px"><p style="margin:0;color: #A0A0A0;font-size: 12px;font-weight: 400;line-height: 150%;text-align:right">Política de privacidad</p></td>
                    <td style="padding-left: 8px"><p style="margin:0;color: #A0A0A0;font-size: 12px;font-weight: 400;line-height: 150%;text-align:left">Cancelar suscripción</p></td>
                </tr>
            </table>
        </div>
    </div>
