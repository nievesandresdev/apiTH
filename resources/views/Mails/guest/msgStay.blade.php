...
<body style="margin: 0; padding: 0; background-color: #FAFAFA;">
    <div style="width: 100%; max-width: 600px; margin: 0 auto;background-color: #ffff;">
        ...
        <section style="margin: 12px;  background: #FFFFFF; border-radius: 3px;">
            ...
            <!-- Tabla de íconos -->
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top: 16px; text-align: center; padding-left : 50px; padding-right: 60px ; width:100%">
                <tr>
                    <!-- Muy Mala -->
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="#" target="_blank" style="text-decoration: none; background: #333; color: #FFF; font-family: Roboto, sans-serif; font-size: 14px; padding: 12px 29px; border-radius: 6px; display: inline-block; width: 260px; height: 44px; text-align: center; line-height: 44px;">
