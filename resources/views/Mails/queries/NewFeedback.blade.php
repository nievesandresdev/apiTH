                ...
                <tr>
                    <td class="text-content order-1" style="color: white; padding-right: 40px; text-align: left; width: 70%; vertical-align: top;">
                        @if($type == 'pending')
                            ...
                            <span style="display: block; margin: 10px 0 22px 0; font-size: 16px; font-style: normal; font-weight: 500; line-height: 130%;">Han transcurrido <span style="color: #FFD453;">10 minutos</span> desde que un huésped ha brindado un feedback acerca de su experiencia en el {{ $hotel->type }} {{ $hotel->name }}. Responde cuanto antes.</span>
                        @else
                            <span style="font-size: 32px; font-style: normal; font-weight: 600; line-height: 110%; margin: 0;">Tienes un nuevo feedback</span>
                            <span style="display: block; margin: 10px 0 22px 0; font-size: 16px; font-style: normal; font-weight: 500; line-height: 130%;">Un huésped ha brindado un feedback acerca de su experiencia en tu {{ $hotel->type }} {{ $hotel->name }}.</span>
                        @endif
