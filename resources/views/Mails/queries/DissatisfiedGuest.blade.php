    ...
    <div style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffff;">
        ...
        <div class="container-hero" style="border-radius: 0px 72px 0px 0px; background: linear-gradient(90deg, #0B6357 -17.99%, #34A98F 118.23%);">
            <table class="responsive-table" role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="font-family: Arial, sans-serif;">
                <tr>
                    <td class="text-content order-1" style="color: white; text-align: left; width: 50%; vertical-align: top; font-family: Arial, sans-serif;">
                        <div class="container-text">
                            <h1 class="title" style="line-height: 110%; font-family: Arial, sans-serif;margin: 0;">Huésped disconforme</h1>
                            <span style="display: block; margin-top: 12px; font-size: 16px; font-style: normal; font-weight: 500; line-height: 130%; font-family: Arial, sans-serif;">
        ...
        <div class="container-content">
            <div class="card-wrong" style="border-radius: 20px;border: 2px solid #E9E9E9;background: #FFF;padding: 24px;">
                <h2 style="font-size: 20px;font-weight: 500;line-height: 110%;font-family: Arial, sans-serif;margin: 0;">{{$data['guestName']}}</h2>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-data" style="margin:0; padding:0;">{{$data['textDate']}}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><img src="{{ asset('mails/icons/1.TH.CLOCK.png') }}" style="width: 16px; height: 16px;margin-right: 8px;margin-top: 2px;"></td>
                                        <td><p class="text-data" style="margin:0; padding:0;">{{$data['respondedHour']}}</p></td>
                                    </tr>
                                    <tr>
                                        <td><img src="{{ asset('mails/icons/flags/'.$data['langAbbr'].'.svg') }}" style="width: 16px; height: 16px;margin-right: 8px;margin-top: 2px;"></td>
                                        <td><span class="text-data" style="margin:0; padding:0;">{{$data['languageResponse']}}</span><span style="font-size: 12px; font-weight: 400; line-height: 110%;text-style: italic;"> (Idioma original)</span></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <h2 style="font-size: 16px;font-weight: 500;line-height: 130%;font-family: Arial, sans-serif;margin-top: 16px;">{{ $data['question'] }}</h2>
                <p style="font-size: 14px;font-weight: 400;line-height: 150%;font-family: Arial, sans-serif;margin-top: 8px;">
                    {{ $data['comment']}}
                </p>
                <div style="margin-top: 16px;text-align: right;">
                    <a class="card-link" href="{{$data['urlToStay']}}" style="text-decoration: underline;color: #333;line-height: 130%;">Ver la estancia</a>
                </div>
            </div>

            <div style="margin-top: 32px;text-align: center;">
                <a href="mailto:{{$data['guestEmail']}}" class="go-report-button">
