                ...
                <tr>
                    <td class="text-content order-1" style="color: white; text-align: left; width: 50%; vertical-align: top; font-family: Arial, sans-serif;">
                        <div class="container-text">
                            <h1 class="title" style="line-height: 110%; font-family: Arial, sans-serif;margin: 0;">Informe de Seguimiento</h1>
            ...
            <div style="border-radius: 16px;border: 1px solid #333;background: #FFF2CC;padding: 16px;margin-top: 32px;">
                <table>
                    <tr>
                        ...
                        <td>
                            <h4 style="margin: 0; font-size: 16px; font-weight: 500; line-height: 110%; font-family: Arial, sans-serif;">¿Pocas respuestas de Seguimiento?</h4>
                        </td>
                    </tr>
                </table>
