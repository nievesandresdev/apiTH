...
<body style="margin: 0;padding: 0;font-family: Arial, sans-serif;">
    <div style="padding: 32px 24px;">
        ...
        <div style="margin-top: 40px;">
            ...
            <div style="margin-top: 22px; padding: 16px; border-radius: 10px;border: 0.623px solid #bfbfbf; width: 552px;">
                        ...
                        <td>
                            ...
                            <table style="margin-left: auto;">
                                <tr>
                                    ...
                                    <td><img src="{{ asset('mails/icons/flags/'.$data['guestLanguageAbbr'].'.svg') }}" alt="User" style="width: 14px;height: 14px;display: inline; margin-right: 4px;"></td>
    ...
    <div style="margin:0;margin-top: 210px;background: #FFF;box-shadow: 0px -4px 4px 0px rgba(0, 0, 0, 0.25);width: 100%;height: 128px; display:block;padding: 54px 0;box-sizing: border-box;">
