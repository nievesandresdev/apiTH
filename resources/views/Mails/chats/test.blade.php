...
<body style="margin: 0; padding: 0; background-color: #ffffff;">
                ...
                <td>
                    <div>
                        ...
                        <div class="align-boton" style="margin-top:32px;"> 
                            <a style="height: 44px;padding: 12px 0;border-radius: 6px;background-color: #333;color: #FFF;text-align: center;font-family: 'Montserrat';font-size: 18px;font-weight: 600;line-height: 110%;box-sizing: border-box;display: block;">
                                Ir a la WebApp
                            </a>
                        </div>
                    </div>
    ...
    <div class="responsive-table-2" style="margin:auto;padding: 40px 24px 48px 24px;border-radius: 3px 3px 50px 3px;background: #F3F3F3;max-width:450px">
        ...
        <div style="margin-top: 24px">
            ...
            <p style="font-family: 'Montserrat';margin:0;font-size: 16px;font-weight: 400;line-height: 150%;margin-top:16px">Tienes un chat pendiente en la WebApp que requiere tu atención. Te recomendamos revisarlo lo antes posible.</p>
            <div class="align-boton" style="margin-top:32px;"> 
                <a style="padding: 12px 0;border-radius: 6px;background-color: #333;color: #FFF;text-align: center;font-family: 'Montserrat';font-size: 18px;font-weight: 600;line-height: 110%;box-sizing: border-box;display: block;">
                    Ir a la WebApp
                </a>
            </div>
        </div>
    ...
    <div style="margin-top: 16px;margin-bottom: 64px; padding:0 24px">
        ...
        <div style="max-width:355px;margin:auto;padding: 32px 32px 40px 32px;background: #F3F3F3; border-radius: 10px;margin-top:24px">
            ...
            <div style="text-align: center; margin-top:40px;">
                <a style="padding: 12px 0;border-radius: 6px;background-color: #333;color: #FFF;text-align: center;font-family: 'Montserrat';font-size: 18px;font-weight: 600;line-height: 110%;display: block;box-sizing: border-box;">
                    Ir a la WebApp
                </a>
            </div>
        </div>
