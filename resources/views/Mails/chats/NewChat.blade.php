...
<body style="margin: 0; padding: 0; background-color: #FAFAFA;">
    <div style="width: 100%; max-width: 600px; margin: 0 auto;background-color: #ffff;">
                ...
                <tr>
                    <td class="text-content order-1" style="color: white; padding-right: 40px; text-align: left; width: 50%; vertical-align: top;">
                        ...
                        <div style="text-align: center; margin-top: 22px;">
                            <a href="{{$url}}" class="full-width-button order-3" style="display: inline-block; padding: 12px 20px; background-color: #FFD453; color: #000; text-decoration: none; border-radius: 4px; font-size: 16px; font-weight: 600; width: 100%; height: 45px; box-sizing: border-box;">Atender Chat</a>
                        </div>
                    </td>
                    <td class="order-2" style="text-align: center; width: 50%; vertical-align: top;">
                        ...
                        <div style="text-align: center; margin-top: 22px;">
                            <a href="{{$url}}" class="full-width-button order-4" style="display: inline-block; padding: 12px 20px; background-color: #FFD453; color: #000; text-decoration: none; border-radius: 4px; font-size: 16px; font-weight: 600; width: 100%; height: 45px; box-sizing: border-box;">Atender Chat</a>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <div style="background-color: white; padding: 20px; text-align: left;">
            ...
            <div style="text-align: center; margin-top: 22px;">
                <a href="{{$url}}" class="full-width-button" style="display: inline-block; padding: 12px 20px; background-color: #FFD453; color: #000; text-decoration: none; border-radius: 4px; font-size: 16px; font-weight: 600; width: 100%; height: 45px; box-sizing: border-box;">Atender Chat</a>
            </div>
        </div>
