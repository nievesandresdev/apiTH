...
<body style="background-color: #ffffff; font-family: 'Montserrat', Arial, sans-serif; margin: 0; padding: 20px;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border: 1px solid #ddd; border-radius: 8px; padding: 20px;">
        ...
        <!-- Primer Párrafo -->
        <p style="font-size: 18px; font-style: normal; font-weight: 400; line-height: 28px; color: #333; text-align: left;">
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ config('app.hoster_url') . 'reset-password/' . $token . '?email=' . $notifiable->getEmailForPasswordReset() }}"
               style="background-color: #FFD453; color: #000; padding: 10px 20px; border-radius: 5px; font-size: 18px; font-weight: 400; text-decoration: none; display: inline-block;">
