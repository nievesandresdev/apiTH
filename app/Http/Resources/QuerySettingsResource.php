...
class QuerySettingsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $guestName = $request->guestName ?? '[nombreHuesped]';
        return [
            ...
            "in_stay_verygood_response_title" => str_replace("[nombreHuesped]", $guestName, $this->in_stay_verygood_response_title[localeCurrent()]),
            ...
            "in_stay_verygood_no_request_thanks_title" => str_replace("[nombreHuesped]", $guestName, $this->in_stay_verygood_no_request_thanks_title[localeCurrent()]),
            ...
            "in_stay_good_response_title" => str_replace("[nombreHuesped]", $guestName, $this->in_stay_good_response_title[localeCurrent()]),
            ...
            "in_stay_good_no_request_thanks_title" => str_replace("[nombreHuesped]", $guestName, $this->in_stay_good_no_request_thanks_title[localeCurrent()]),
            "in_stay_good_no_request_thanks_msg" => $this->in_stay_good_no_request_thanks_msg[localeCurrent()],
            //
            "in_stay_bad_response_title" => str_replace("[nombreHuesped]", $guestName, $this->in_stay_bad_response_title[localeCurrent()]),
            "in_stay_bad_response_msg" => $this->in_stay_bad_response_msg[localeCurrent()],
            ///////////////////////
            "post_stay_verygood_response_title" => str_replace("[nombreHuesped]", $guestName, $this->post_stay_verygood_response_title[localeCurrent()]),
            ...
            "post_stay_good_response_title" => str_replace("[nombreHuesped]", $guestName, $this->post_stay_good_response_title[localeCurrent()]),
            ...
            "post_stay_good_no_request_thanks_title" => str_replace("[nombreHuesped]", $guestName, $this->post_stay_good_no_request_thanks_title[localeCurrent()]),
            "post_stay_good_no_request_thanks_msg" => $this->post_stay_good_no_request_thanks_msg[localeCurrent()],
            //
            "post_stay_bad_response_title" => str_replace("[nombreHuesped]", $guestName, $this->post_stay_bad_response_title[localeCurrent()]),
