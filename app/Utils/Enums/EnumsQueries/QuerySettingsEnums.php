...
class QuerySettingsEnums
{
    ...
    public static function inStayqueriesTextDefault(): stdClass
    {
        ...
        $queriesTextDefault->in_stay_verygood_response_msg = [
            "es" => '<p>Tu experiencia es muy importante, y puede ayudar a otros viajeros a conocernos. ¿Nos dejas tu reseña?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Agradecemos tu tiempo y ¡Gracias por habernos elegido!</p>',
            "en" => '<p>Your experience is very important, and it can help other travelers to know us. Would you leave us your review?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Thank you for your time and ¡Thank you for choosing us!</p>',
            "fr" => "<p>Votre expérience est très importante, et elle peut aider d'autres voyageurs à nous connaître. Voudriez-vous nous laisser votre avis ?</p><p><br></p><p><strong>[Enlaces a OTAs OTAs]</strong></p><p><br></p><p class='ql-align-center'>Nous vous remercions de votre temps et ¡Merci d'avoir choisi notre hôtel !</p>",
            "pt" => '<p>Sua experiência é muito importante, e pode ajudar outros viajantes a nos conhecerem. Você nos deixaria sua redação?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Agradecemos seu tempo e ¡Obrigado por escolher nosso hotel!</p>',
            "it" => '<p>La tua esperienza è molto importante, e può aiutare altri viaggiatori a conoscerci. Ti lasceresti il tuo commento?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Grazie per il tuo tempo e ¡Grazie per aver scelto il nostro hotel!</p>',
            "de" => '<p>Ihre Erfahrung ist sehr wichtig und kann anderen Reisenden helfen, uns kennen zu lernen. Möchten Sie uns Ihre Bewertung hinterlassen?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Wir danken Ihnen für Ihre Zeit und ¡Danke für Ihre Wahl!</p>',
            "ca" => '<p>La teva experiència és molt important, i pot ajudar altres viatgers a conèixer-nos. Voldria deixar-nos el teu comentari?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Gràcies pel teu temps i ¡Gràcies per triar el nostre hotel!</p>',
            "eu" => '<p>Zure esperientzia da garrantzitsua da, eta beste errebetariak gurekin bat egin dezaketen. Zure iritzia utzi ditzakezu?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Eskerrik asko denbora eta ¡Eskerrik asko hartu dugu!</p>',
            "gl" => '<p>A túa experiencia é muito importante, e pode axudar outros viaxeiros a coñecernos. ¿Deixarías a túa reseña?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Agradecemos o teu tempo e ¡Grazas por escoller o noso hotel!</p>',
            "nl" => '<p>Je ervaring is zeer belangrijk, en kan andere reizigers helpen om ons te leren kennen. Wilt u ons uw beoordeling achterlaten?</p><p><br></p><p><strong>[Enlaces a OTAs]</strong></p><p><br></p><p class="ql-align-center">Bedankt voor je tijd en ¡Bedankt voor je keuze!</p>'
        ];
