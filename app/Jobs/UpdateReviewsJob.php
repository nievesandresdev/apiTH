...
class UpdateReviewsJob implements ShouldQueue
{
    ...
    public function __construct($apiReviewService, $notificationDiscordService)
    {
    ...
    public function handle(): void
    {
        ...
        $this->notificationDiscordService->sendMessage("Start UpdateReviewsCommand", "Start UpdateReviewsCommand");
