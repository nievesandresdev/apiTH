...
if (! function_exists('inStayqueriesTextDefault')) {
    ...
    function inStayqueriesTextDefault(){
        ...
        $queriesTextDefault->in_stay_thanks_good = [
            "es" => "¡Nos alegra mucho saber que estás disfrutando tu estancia! Agradecemos sinceramente tu feedback.",
            "en" => "We are very happy to know that you are enjoying your stay! We sincerely appreciate your feedback.",
            "fr" => "Nous sommes très heureux de savoir que vous profitez de votre séjour ! Nous vous remercions sincèrement pour votre retour.",
            "pt" => "Estamos muito felizes em saber que está a desfrutar da sua estadia! Agradecemos sinceramente o seu feedback.",
            "it" => "Siamo molto felici di sapere che stai godendo del tuo soggiorno! Ti ringraziamo sinceramente per il tuo feedback.",
            "de" => "Wir freuen uns sehr, dass Sie Ihren Aufenthalt genießen! Vielen Dank für Ihr Feedback.",
            "ca" => "Ens alegra molt saber que estàs gaudint de la teva estada! Agraïm sincerament el teu feedback.",
            "eu" => "Pozten gaitu zure egonaldiaz gozatzen ari zarela jakiteak! Zinez eskertzen dugu zure iritzia.",
            "gl" => "Encántanos saber que estás gozando da túa estadía! Agradecemos sinceramente o teu feedback.",
            "nl" => "We zijn erg blij te horen dat je van je verblijf geniet! We waarderen je feedback oprecht."
        ];
        
        $queriesTextDefault->in_stay_assessment_good_activate = false;
        $queriesTextDefault->in_stay_assessment_good = [
            "es" => "Nos encantaría saber más detalles, buscamos mejorar tu experiencia.",
            "en" => "We’d love to hear more details — we’re always looking to improve your experience.",
            "fr" => "Nous aimerions en savoir plus — nous cherchons à améliorer votre expérience.",
            "de" => "Wir würden gerne mehr Details erfahren – wir möchten Ihre Erfahrung verbessern.",
            "it" => "Ci piacerebbe conoscere più dettagli, vogliamo migliorare la tua esperienza.",
            "pt" => "Adoraríamos saber mais detalhes, buscamos melhorar a sua experiência.",
            "ca" => "Ens encantaria saber més detalls, volem millorar la teva experiència.",
            "eu" => "Xehetasun gehiago jakin nahiko genituzke, zure esperientzia hobetzen saiatzen gara.",
            "gl" => "Encantaríanos saber máis detalles, buscamos mellorar a túa experiencia.",
            "nl" => "We horen graag meer details — we willen jouw ervaring verbeteren."
        ];
        
        $queriesTextDefault->in_stay_thanks_normal = [
            "es" => "Lamentamos que tu estancia no esté siendo la ideal. ¿Te importaría darnos más detalles?",
            "en" => "We’re sorry your stay hasn’t been ideal. Would you mind sharing more details with us?",
            "fr" => "Nous sommes désolés que votre séjour ne soit pas idéal. Pourriez-vous nous en dire un peu plus ?",
            "pt" => "Lamentamos que a sua estadia não esteja sendo a ideal. Poderia nos dar mais detalhes?",
            "it" => "Ci dispiace che il tuo soggiorno non sia stato l’ideale. Ti andrebbe di darci qualche dettaglio in più?",
            "de" => "Es tut uns leid, dass Ihr Aufenthalt nicht ideal verläuft. Würden Sie uns mehr Details mitteilen?",
            "ca" => "Lamentem que la teva estada no estigui sent l’ideal. Ens podries donar més detalls?",
            "eu" => "Barkatu zure egonaldia ez delako nahi bezalakoa izaten ari. Eman al zeniguke xehetasun gehiago?",
            "gl" => "Lamentamos que a túa estadía non estea sendo a ideal. Poderías darnos máis detalles?",
            "nl" => "Het spijt ons dat je verblijf niet ideaal verloopt. Zou je ons wat meer details willen geven?"
        ];
        
        $queriesTextDefault->in_stay_assessment_normal_activate = true;
        $queriesTextDefault->in_stay_assessment_normal = [
            "es" => "Cuéntanos cómo podemos mejorar tu experiencia...",
            "en" => "Tell us how we can improve your experience...",
            "fr" => "Dites-nous comment nous pourrions améliorer votre expérience...",
            "pt" => "Conte-nos como podemos melhorar a sua experiência...",
            "it" => "Dicci come possiamo migliorare la tua esperienza...",
            "de" => "Sagen Sie uns, wie wir Ihr Erlebnis verbessern können...",
            "ca" => "Explica’ns com podem millorar la teva experiència...",
            "eu" => "Esaguzu nola hobetu dezakegun zure esperientzia...",
            "gl" => "Cóntanos como podemos mellorar a túa experiencia...",
            "nl" => "Vertel ons hoe we jouw ervaring kunnen verbeteren..."
        ];
...
if (! function_exists('postStayqueriesTextDefault')) {
    ...
    function postStayqueriesTextDefault(){
        ...
        $queriesTextDefault->post_stay_thanks_good = [
            ...
            "en" => "We’re very glad to know you enjoyed your stay. We truly appreciate your feedback and hope to continue meeting your expectations.",
            "fr" => "Nous sommes très heureux d’apprendre que vous avez apprécié votre séjour. Nous vous remercions sincèrement pour votre retour et espérons continuer à répondre à vos attentes.",
            "pt" => "Estamos muito felizes em saber que gostou da sua estadia. Agradecemos sinceramente o seu feedback e esperamos continuar a corresponder às suas expectativas.",
            "it" => "Siamo molto felici di sapere che hai apprezzato il tuo soggiorno. Ti ringraziamo sinceramente per il tuo feedback e speriamo di continuare a soddisfare le tue aspettative.",
            "de" => "Wir freuen uns sehr, dass Sie Ihren Aufenthalt genossen haben. Vielen Dank für Ihr Feedback – wir hoffen, auch weiterhin Ihre Erwartungen zu erfüllen.",
            "ca" => "Ens alegra molt saber que has gaudit de la teva estada. Agraïm sincerament el teu feedback i esperem continuar complint les teves expectatives.",
            "eu" => "Pozten gaitu zure egonaldiaz gozatu duzula jakiteak. Zinez eskertzen dugu zure iritzia eta espero dugu zure itxaropenak betetzen jarraitzea.",
            "gl" => "Encántanos saber que desfrutaches da túa estadía. Agradecemos sinceramente o teu feedback e esperamos seguir cumprindo coas túas expectativas.",
            "nl" => "We zijn erg blij te horen dat je van je verblijf hebt genoten. We waarderen je feedback oprecht en hopen aan je verwachtingen te blijven voldoen."
        ];
        

        $queriesTextDefault->post_stay_assessment_good_activate = false;
        ...
        $queriesTextDefault->post_stay_thanks_normal = [
            "es" => "Lamentamos que tu estancia no haya sido la ideal. ¿Te importaría darnos más detalles?",
            "en" => "We’re sorry your stay wasn’t ideal. Would you mind sharing more details with us?",
            "fr" => "Nous sommes désolés que votre séjour n’ait pas été idéal. Pourriez-vous nous en dire un peu plus ?",
            "de" => "Es tut uns leid, dass Ihr Aufenthalt nicht ideal war. Würden Sie uns mehr Details mitteilen?",
            "it" => "Ci dispiace che il tuo soggiorno non sia stato l’ideale. Ti andrebbe di darci qualche dettaglio in più?",
            "pt" => "Lamentamos que a sua estadia não tenha sido a ideal. Poderia nos dar mais detalhes?",
            "ca" => "Lamentem que la teva estada no hagi estat l’ideal. Ens podries donar més detalls?",
            "eu" => "Barkatu zure egonaldia ez delako nahi bezalakoa izan. Eman al zeniguke xehetasun gehiago?",
            "gl" => "Lamentamos que a túa estadía non fose a ideal. Poderías darnos máis detalles?",
            "nl" => "Het spijt ons dat je verblijf niet ideaal was. Zou je ons wat meer details willen geven?"
        ];        
