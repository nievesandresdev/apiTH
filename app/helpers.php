...
if (! function_exists('inStayqueriesTextDefault')) {
    function inStayqueriesTextDefault(){
        ...
        $queriesTextDefault->in_stay_assessment_good = [
            "es" => "Nos encantaría saber más detalles de tu opinión sobre el hotel y el personal, tratamos de mejorar tu experiencia.",
...
if (! function_exists('requestSettingsDefault')) {
    function requestSettingsDefault(){
        ...
        $requestSettings->in_stay_msg_text = [
            ...
            "ca" => '<p>La teva experiència és molt important, compartir-la ajudaria altres viatgers a conèixer-nos.</p><p><br></p><p><strong>[Enllaç a les OTAs]</strong></p><p><br></p><p>Si vas reservar en línia, és possible que et demanin la teva opinió aviat. Valorem molt que l’hagis compartida.</p><p><br></p><p class="ql-align-center"><strong>Agraïm el teu temps i gràcies per haver-nos triat!</strong></p>',
