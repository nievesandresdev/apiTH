...
class DemoStaysSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($hotels as $hotel) {
            // Verificar si el hotel ya tiene una estancia demo
            $existingDemoStay = $hotel->stays()->where('is_demo', true)->first();

            if (!$existingDemoStay) {
                // Verificar si el hotel tiene alguna estancia
                $hasAnyStay = $hotel->stays()->exists();
