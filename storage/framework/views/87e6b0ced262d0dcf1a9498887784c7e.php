...
<div style="background-color: #1A1A1A; padding: 32px; text-align: center; color: #ffffff;">
    <img src="<?php echo e(asset('mails/logo-white.png')); ?>" alt="Thehoster Logo" style="display: block; margin: 0 auto 20px;">

    <!-- New icons for web and LinkedIn -->
    <div style="margin-bottom: 20px;">
        <a href="https://thehoster.io/" target="_blank" style="margin-right: 16px;">
            <img src="<?php echo e(asset('mails/web.png')); ?>" alt="Website Icon" style="width: 24px; height: 24px;">
        </a>
        <a href="https://www.linkedin.com/company/the-hoster/" target="_blank">
            <img src="<?php echo e(asset('mails/linkedin.png')); ?>" alt="LinkedIn Icon" style="width: 24px; height: 24px;">
        </a>
    </div>
    ...
    <div class="responsive-footer-links" style="margin-bottom: 24px; margin-top:16px;">
        ...
        <?php if($showNotify): ?>
            <a href="<?php echo e($url); ?>equipo/configuracion/usuarios?n=<?php echo e($showNotify); ?>" class="config-notifications" style="color: #A0A0A0; text-decoration: none; font-size: 12px; font-style: normal; font-weight: 400; line-height: 150%;">Configurar notificaciones</a>
        <?php endif; ?>
    </div>
...
<?php /**PATH C:\laragon\www\api-hoster\resources\views/components/mails/footer.blade.php ENDPATH**/ ?>